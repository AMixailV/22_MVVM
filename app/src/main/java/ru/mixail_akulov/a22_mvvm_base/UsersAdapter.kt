...
import ru.mixail_akulov.a22_mvvm_base.databinding.ItemUserBinding
import ru.mixail_akulov.a22_mvvm_base.model.User
import ru.mixail_akulov.a22_mvvm_base.screens.UserListItem
...
class UsersAdapter(
    ...
    // 11.8 меняем User на UserListItem
